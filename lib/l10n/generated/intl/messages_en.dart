...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(status) =>
      "${Intl.select(status, {'status_0': 'No status', 'status_1': 'Watched', 'status_2': 'Watching', 'status_3': 'Going to Watch', 'status_4': 'Stopped Watching', 'status_5': 'Won\'t Watch'})}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "aiRecommendation": MessageLookupByLibrary.simpleMessage(
      "AI Recommendation",
    ),
    ...
    "trendingMovies": MessageLookupByLibrary.simpleMessage("Trending movies"),
    "trendingPersons": MessageLookupByLibrary.simpleMessage("Trending persons"),
