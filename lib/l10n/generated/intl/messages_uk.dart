...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m9(status) =>
      "${Intl.select(status, {'status_0': 'Без статусу', 'status_1': 'Подивився', 'status_2': 'Дивлюсь', 'status_3': 'Дивитимуся', 'status_4': 'Перестав', 'status_5': 'Не дивитимусь'})}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "addToTheList": MessageLookupByLibrary.simpleMessage("Додати до списку"),
    "aiRecommendation": MessageLookupByLibrary.simpleMessage("AI Рекомендації"),
    "aiRecommendationList": MessageLookupByLibrary.simpleMessage(
      "Список AI рекомендацій",
    ),
    ...
    "findAnythingWelcome": MessageLookupByLibrary.simpleMessage(
    ...
    "movieCrew": MessageLookupByLibrary.simpleMessage("Знімальна група фільму"),
    ...
    "placeOfBirth": MessageLookupByLibrary.simpleMessage("Місце народження:"),
    "playTrailer": MessageLookupByLibrary.simpleMessage("Переглянути трейлер"),
    ...
    "seriesCast": MessageLookupByLibrary.simpleMessage(
      "Акторський склад серії",
    ),
    "seriesCrew": MessageLookupByLibrary.simpleMessage("Знімальна група серії"),
    "seriesGuestStars": MessageLookupByLibrary.simpleMessage("Запрошені зірки"),
    "socialNetwork": MessageLookupByLibrary.simpleMessage("Соціальні мережі"),
    "theListIsEmpty": MessageLookupByLibrary.simpleMessage("Список порожній."),
    ...
    "theRatingWasDeletedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Оцінку успішно видалено.",
    ),
    "trailers": MessageLookupByLibrary.simpleMessage("Трейлери"),
    "trendingMovies": MessageLookupByLibrary.simpleMessage("Популярні фільми"),
    "trendingPersons": MessageLookupByLibrary.simpleMessage(
      "Популярні знаменитості",
    ),
    "trendingTvs": MessageLookupByLibrary.simpleMessage("Популярні серіали"),
    ...
    "watchlist": MessageLookupByLibrary.simpleMessage("Список для перегляду"),
