...
class MovieCrewWidget extends StatelessWidget {
  const MovieCrewWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Movie Crew"),
      ),
...
class _BodyWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final model = NotifierProvider.watch<MovieCrewModel>(context);
